...
class ClickbaitDetectorTrainer:
    def __init__(self):
...
if __name__ == "__main__":
    trainer = ClickbaitDetectorTrainer()
    detector = ClickbaitPredictor()

    success = trainer._train(epochs=100)  # Use default epochs for LR
    ...
    if success:
        ...
        for headline in test_headlines:
            is_clickbait, score, confidence = detector.predict(headline)
